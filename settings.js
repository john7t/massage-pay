...
function ChartPage({t,settings,onClose}){
  ...
  return(<div className="fi space-y-4">
    <div className="flex items-center justify-center py-1"><h2 className="text-sm font-semibold text-gray-300">{t.tabChart}</h2></div>
...
function CustomerPage({t,settings,onClose}){
  ...
  return(<div className="fi space-y-3 max-w-lg mx-auto px-4 py-2">
    <div className="flex items-center justify-center py-1"><h2 className="text-sm font-semibold text-gray-300">{t.custMgmt}</h2></div>
...
function SuggestPage({t,settings,onClose}){
  ...
  return(<div className="fi">
    <div className="relative flex items-center justify-center py-1 mb-2"><h2 className="text-sm font-semibold text-gray-300">{t.suggestBox||'建議'}</h2><button onClick={()=>setShowAdd(true)} className="absolute right-0 px-2.5 py-1 rounded-lg bg-amber-600 text-white text-[11px] font-semibold active:bg-amber-700">+ {t.suggestAdd||'新建議'}</button></div>
  ...
  return(
    <div className="flex h-full fi">
      ...
      {subTab==='book'&&(<div className="space-y-4 fi">
        <div className="flex items-center justify-center py-1"><h2 className="text-sm font-semibold text-gray-300">{t.myBooking2}</h2></div>
      ...
      {subTab==='backup'&&(<div className="space-y-4 fi">
        <div className="flex items-center justify-center py-1"><h2 className="text-sm font-semibold text-gray-300">{t.backupCenter}</h2></div>
        <BackupSection settings={settings} t={t}/>
      </div>)}

      {subTab==='violation'&&(<div className="space-y-6 fi">
        <div>
          <div className="flex items-center justify-center py-1 mb-2"><h2 className="text-sm font-semibold text-gray-300">{t.violationTitle}</h2></div>
