...
function BackupSection({settings,t,onUpdate,lineUserId}){
  ...
  const doJsonExport=()=>{
    try{
      ...
      a.href=url;a.download=`備份_${settings.code}_${settings.year}_${dateStr}.json`;
