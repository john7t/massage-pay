        ...
        {(()=>{const ghLocal=getGHConfig();const hasConn=!!(ghLocal&&ghLocal.token);return(
          <div className="space-y-2"><label className="text-xs text-gray-400 mb-1 block">{t.serviceStatus}</label>
            ...
            {connMode==='apply'&&(<div className="space-y-3 fi">
              ...
              <p className="text-[10px] text-gray-600 text-center font-mono select-all break-all">{settings.code}:{devId}</p><button onClick={()=>{const link=location.origin+location.pathname.replace(/index\.html$/,'')+'auth.html#req='+encodeURIComponent(genConnReq(settings.code,devId));location.href='https://line.me/R/share?text='+encodeURIComponent(t.lineConnReqPrefix+'\n'+link)}} className="w-full py-2.5 rounded-xl text-white text-sm font-bold bg-[#06C755] active:bg-[#05b34c]">{t.sendViaLine}</button>
      ...
      {subTab==='basic'&&(<div className="space-y-4 fi">
        ...
        <div className="pt-2 space-y-2">
          ...
          {basicCode&&(<div className="space-y-2 fi">
            ...
            <div className="grid grid-cols-2 gap-2"><button onClick={()=>{navigator.clipboard.writeText(basicCode).catch(()=>{})}} className="py-2.5 rounded-xl bg-white/[0.06] border border-white/[0.08] text-gray-300 text-sm font-medium">{t.copyBtn}</button><button onClick={()=>{const link=location.origin+location.pathname.replace(/index\.html$/,'')+'auth.html#req='+encodeURIComponent(basicCode);location.href='https://line.me/R/share?text='+encodeURIComponent(t.lineReqPrefix+'\n'+link)}} className="py-2.5 rounded-xl text-white text-sm font-bold bg-[#06C755] active:bg-[#05b34c]">{t.sendViaLine}</button></div>
      ...
      {subTab==='store'&&(<div className="space-y-4 fi">
        ...
        <div className="pt-2 space-y-2">
          ...
          {storeCode&&(<div className="space-y-2 fi">
            ...
            <div className="grid grid-cols-2 gap-2"><button onClick={()=>{navigator.clipboard.writeText(storeCode).catch(()=>{})}} className="py-2.5 rounded-xl bg-white/[0.06] border border-white/[0.08] text-gray-300 text-sm font-medium">{t.copyBtn}</button><button onClick={()=>{const link=location.origin+location.pathname.replace(/index\.html$/,'')+'auth.html#req='+encodeURIComponent(storeCode);location.href='https://line.me/R/share?text='+encodeURIComponent(t.lineReqPrefix+'\n'+link)}} className="py-2.5 rounded-xl text-white text-sm font-bold bg-[#06C755] active:bg-[#05b34c]">{t.sendViaLine}</button></div>
