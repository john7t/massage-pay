...
function ChartPage({t,settings,onClose}){
  ...
  return(<div className="fi space-y-4">
    <div className="flex items-center justify-between"><h2 className="text-lg font-bold text-gray-100">{t.tabChart}</h2></div>
...
function CustomerPage({t,settings,onClose}){
  ...
  return(<div className="fi space-y-3 max-w-lg mx-auto px-4 py-2">
    <div className="flex items-center justify-between"><h2 className="text-lg font-bold text-gray-100">{t.custMgmt}</h2></div>
  ...
  return(
    <div className="flex h-full fi">
      ...
      {subTab==='home'&&(<div className="space-y-5 fi">
        <div className="sticky top-0 z-10 -mx-4 px-4 py-2 bg-gray-950 flex items-center justify-between"><h2 className="text-lg font-bold text-gray-100">{t.homeSettings}</h2></div>
      ...
      {subTab==='book'&&(<div className="space-y-4 fi">
        <div className="flex items-center justify-between"><h2 className="text-lg font-bold text-gray-100">{t.myBooking2}</h2></div>
      ...
      {subTab==='backup'&&(<div className="space-y-4 fi">
        <div className="flex items-center justify-between"><h2 className="text-lg font-bold text-gray-100">{t.backupCenter}</h2></div>
        <BackupSection settings={settings} t={t}/>
      </div>)}

      {subTab==='violation'&&(<div className="space-y-6 fi">
        <div>
          <div className="flex items-center justify-between mb-3"><h2 className="text-lg font-bold text-gray-100">{t.violationTitle}</h2></div>
