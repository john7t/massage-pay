...
// 穴道知識庫:每個穴道有中越文的位置(同身寸描述,不靠圖片)/功效/手法/注意事項,keywords供搜尋比對用(症狀關鍵字+名稱本身)
const ACUPOINTS=[
  {id:'taiyang',
    name:{zh:'太陽穴',vi:'Huyệt Thái Dương'},
    keywords:{zh:['太陽穴','頭痛','頭部','提神','眼睛疲勞','用眼過度','頭脹'],vi:['thái dương','đau đầu','mỏi mắt','căng đầu']},
    location:{zh:'眉尾與外眼角連線的中點，往外側約一橫指（食指寬度）處的凹陷處，用指腹按壓會摸到一個明顯的小窩。',vi:'Điểm giữa đường nối đuôi lông mày và đuôi mắt ngoài, cách ra phía ngoài khoảng 1 ngón tay (bề ngang ngón trỏ), tại chỗ lõm rõ khi ấn vào bằng đầu ngón tay.'},
    benefit:{zh:'舒緩頭部緊繃、提神醒腦，客人反映頭痛脹感、用眼過度時常按摩此處。',vi:'Giúp thư giãn vùng đầu, tỉnh táo tinh thần, khách hay phản ánh cảm giác căng đau đầu, mỏi mắt.'},
    technique:{zh:'以雙手拇指指腹輕輕按壓，順時針方向由輕漸重打圈，每次約10-15圈，力道以客人感覺舒適的痠脹感為主，不可用力過猛。',vi:'Dùng đầu ngón cái hai tay ấn nhẹ, xoay tròn theo chiều kim đồng hồ, mỗi lần khoảng 10-15 vòng, lực vừa đủ để khách cảm thấy êm dịu, không dùng lực quá mạnh.'},
    caution:{zh:'此處皮膚薄、靠近眼周，避免尖銳指甲或過度用力；有偏頭痛病史的客人建議力道再放輕。',vi:'Vùng da ở đây mỏng, gần mắt, tránh móng tay nhọn hoặc lực quá mạnh; khách có tiền sử đau nửa đầu nên giảm lực.'}},
  {id:'jianjing',
    name:{zh:'肩井穴',vi:'Huyệt Kiên Tỉnh'},
    keywords:{zh:['肩井穴','肩頸','肩膀痠痛','脖子痠','久坐','僵硬'],vi:['kiên tỉnh','vai gáy','cứng cổ','mỏi vai']},
    location:{zh:'肩膀最高點，脖子與肩膀交界處，大椎穴（低頭時脖子後方最突出的骨頭）與肩峰（肩膀外側最高的骨頭）連線的中點。',vi:'Điểm cao nhất của vai, giao điểm giữa cổ và vai, là trung điểm nối huyệt Đại Chùy (xương nhô cao nhất phía sau cổ khi cúi đầu) và đỉnh vai (xương cao nhất phía ngoài vai).'},
    benefit:{zh:'舒緩肩頸僵硬痠痛，久坐、久站客人最常按摩的部位之一。',vi:'Giúp thư giãn vai gáy cứng mỏi, là vị trí khách ngồi/đứng lâu hay yêu cầu massage nhất.'},
    technique:{zh:'以拇指或掌根由輕漸重按壓，可搭配指腹揉按或掌心搓熱後熱敷，力道漸進加重，停留約3-5秒後放鬆，重複數次。',vi:'Dùng ngón cái hoặc gốc bàn tay ấn từ nhẹ đến mạnh dần, có thể kết hợp xoa bóp bằng đầu ngón tay hoặc áp lòng bàn tay đã làm nóng, lực tăng dần, giữ khoảng 3-5 giây rồi thả lỏng, lặp lại vài lần.'},
    caution:{zh:'孕婦禁按此處（傳統上認為此處按壓力道過重可能引發不適）；心血管疾病患者力道宜輕。',vi:'Phụ nữ mang thai không nên ấn vị trí này (theo truyền thống lực ấn mạnh ở đây có thể gây khó chịu); người có bệnh tim mạch nên dùng lực nhẹ.'}},
  {id:'hegu',
    name:{zh:'合谷穴',vi:'Huyệt Hợp Cốc'},
    keywords:{zh:['合谷穴','手部疲勞','手痠','虎口','提神'],vi:['hợp cốc','mỏi tay','tay','cổ tay']},
    location:{zh:'手背，拇指與食指張開後，兩指骨交會處往虎口方向約一姆指寬（用另一手拇指第一指節寬度衡量）的位置，按壓時會有痠脹感的地方。',vi:'Mu bàn tay, khi ngón cái và ngón trỏ xòe ra, điểm giao giữa hai xương ngón hướng về phía hổ khẩu, cách khoảng 1 bề ngang đốt ngón cái (đo bằng đốt đầu ngón cái tay kia), là chỗ có cảm giác ê khi ấn vào.'},
    benefit:{zh:'舒緩手部疲勞、提神，常用於手部按摩的收尾放鬆。',vi:'Giúp thư giãn mỏi tay, tỉnh táo, thường dùng ở bước cuối khi massage tay.'},
    technique:{zh:'以另一手拇指指腹垂直按壓，力道由輕漸重，停留約5秒後放鬆，可重複5-8次。',vi:'Dùng ngón cái tay kia ấn thẳng xuống, lực từ nhẹ đến mạnh dần, giữ khoảng 5 giây rồi thả lỏng, có thể lặp lại 5-8 lần.'},
    caution:{zh:'孕婦禁按（傳統上認為此穴按壓力道過重可能引發子宮收縮，安全起見一律避免）。',vi:'Phụ nữ mang thai không nên ấn (theo truyền thống lực ấn mạnh ở huyệt này có thể gây co bóp tử cung, nên tránh hoàn toàn để an toàn).'}},
  {id:'zusanli',
    name:{zh:'足三里',vi:'Huyệt Túc Tam Lý'},
    keywords:{zh:['足三里','腿部疲勞','腿痠','循環不良','久站','久走'],vi:['túc tam lý','mỏi chân','chân','tuần hoàn']},
    location:{zh:'膝蓋外側凹陷處（外膝眼）直下四橫指（食指到小指併攏的寬度），脛骨外側約一橫指處。',vi:'Từ chỗ lõm bên ngoài đầu gối (mắt gối ngoài) đo thẳng xuống 4 ngón tay (bề ngang 4 ngón từ trỏ đến út khép lại), cách xương ống chân khoảng 1 ngón tay về phía ngoài.'},
    benefit:{zh:'舒緩腿部疲勞、促進循環，久站久走的客人常反映此處按摩後感覺腿部輕鬆。',vi:'Giúp thư giãn mỏi chân, hỗ trợ tuần hoàn, khách đứng/đi nhiều hay phản ánh cảm giác nhẹ chân sau khi massage vị trí này.'},
    technique:{zh:'以拇指指腹垂直按壓或打圈按摩，力道中等偏重（此處肌肉較厚，可承受較大力道），每次停留約5-10秒。',vi:'Dùng đầu ngón cái ấn thẳng hoặc xoay tròn, lực vừa đến hơi mạnh (vùng cơ ở đây dày, chịu được lực lớn hơn), mỗi lần giữ khoảng 5-10 giây.'},
    caution:{zh:'一般無特殊禁忌，但下肢有傷口、靜脈曲張嚴重者建議避開該區域。',vi:'Thường không có chống chỉ định đặc biệt, nhưng nếu chân dưới có vết thương hoặc giãn tĩnh mạch nặng nên tránh vùng này.'}},
  {id:'yongquan',
    name:{zh:'湧泉穴',vi:'Huyệt Dũng Tuyền'},
    keywords:{zh:['湧泉穴','足部疲勞','腳痠','失眠','放鬆','足底'],vi:['dũng tuyền','mỏi chân','khó ngủ','lòng bàn chân']},
    location:{zh:'腳底，腳趾向下彎曲時，足底前1/3處會出現的凹陷處（約是腳掌長度前1/3與後2/3交界的中線位置）。',vi:'Lòng bàn chân, khi các ngón chân cong xuống, chỗ lõm xuất hiện ở khoảng 1/3 phía trước lòng bàn chân (khoảng giao điểm giữa 1/3 trước và 2/3 sau chiều dài bàn chân, trên đường giữa).'},
    benefit:{zh:'舒緩足部疲勞、幫助放鬆入睡，是足部按摩最常按壓的重點部位之一。',vi:'Giúp thư giãn mỏi chân, hỗ trợ thư giãn dễ ngủ, là vị trí trọng điểm hay ấn nhất khi massage chân.'},
    technique:{zh:'以拇指指腹或指節由輕漸重按壓，可搭配按摩油輔助，力道依客人耐受度調整，此處敏感者力道宜輕，可耐重力者可加重按壓並停留。',vi:'Dùng đầu ngón cái hoặc khớp ngón ấn từ nhẹ đến mạnh dần, có thể kết hợp dầu massage, lực điều chỉnh theo mức chịu đựng của khách, người nhạy cảm nên dùng lực nhẹ, người chịu lực tốt có thể ấn mạnh và giữ lâu hơn.'},
    caution:{zh:'孕婦、發燒中客人建議避開或力道放至最輕；此處神經末梢豐富，第一次按壓建議先以輕力道測試客人反應。',vi:'Phụ nữ mang thai, khách đang sốt nên tránh hoặc dùng lực nhẹ nhất; vùng này nhiều đầu dây thần kinh, lần đầu ấn nên thử lực nhẹ trước để xem phản ứng của khách.'}},
];
...
window.MP={
  ...
  getCustomers,saveCustomers,getBookings,saveBookings,uid,upsertCustomer,normPhone,searchCustomers,addBooking,updateBooking,deleteBooking,confirmBooking,BOOK_TITLES,bookTitleName,ACUPOINTS,
