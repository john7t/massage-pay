...
curStore:"目前服務店家",applyChange:"申請更改",genBasicCode:"產生基資申請碼",genStoreCode:"產生店資申請碼",basicApplyCode:"基資申請碼",storeApplyCode:"店資申請碼",confirmCode2:"確認碼",copyBtn:"複製",lastSyncAt:"最後同步時間",bizCutoffLabel:"首頁換頁時間點",bizCutoffHint:"每日到此時間點換到新的一天（跨夜班用，預設06:30）",fullStaffData:"完整資料",fullBasicData:"基資完整資料",fullStoreData:"店資完整資料",saveToStaff:"存回 staff",saved:"已存回",saveFailStaff:"存檔失敗",staffValueHint:"公司登記",
...
curStore:"Cửa hàng hiện tại",applyChange:"Xin đổi",genBasicCode:"Tạo mã hồ sơ",genStoreCode:"Tạo mã cửa hàng",basicApplyCode:"Mã hồ sơ",storeApplyCode:"Mã cửa hàng",confirmCode2:"Mã xác nhận",copyBtn:"Sao chép",lastSyncAt:"Đồng bộ lần cuối",bizCutoffLabel:"Giờ chuyển ngày",bizCutoffHint:"Đến giờ này chuyển sang ngày mới (ca qua đêm, mặc định 06:30)",fullStaffData:"Dữ liệu đầy đủ",fullBasicData:"Hồ sơ cơ bản",fullStoreData:"Hồ sơ cửa hàng",saveToStaff:"Lưu vào staff",saved:"Đã lưu",saveFailStaff:"Lưu thất bại",staffValueHint:"Công ty ghi",
