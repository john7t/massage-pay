/* ════════════════════════════════════════════════════════════
   ...
   v1.8-057 / LINE分享文字帶老師編號(修undefined)+移除step2複製鈕只留LINE鈕;管理頁產生連線碼/啟動碼結果改LINE傳送鈕(移除複製鈕)
