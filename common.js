...
async function publishNotices(gh,limit,onStep){
  ...
  let r;
  try{r=await gasCall('publishNotices',{limit:limit||2},40000);}catch(e){return {ok:false,error:'gas exception:'+e,step:'連GAS'};}
