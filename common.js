...
function getGasUrl(){try{const s=LS.get('app-settings');if(s&&s.gasUrl)return s.gasUrl}catch(_e){}try{return localStorage.getItem('gas-url')||''}catch(_e){}return ''}
