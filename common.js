/* ════════════════════════════════════════════════════════════
   ...
   v1.8-041 / 流水記錄地基(+1建流水含時間)+每日編輯流水列表(修正開始時間+hashtag客管標籤)
...
function newSlip(units){const now=Date.now();return{id:'S'+now+Math.floor(Math.random()*1000),units:units||1,createdAt:now,startAt:0,tags:[]}}
// 取流水的有效開始時間(修正過優先)
...
global.MP={
  ...
  newSlip,slipStartTime,loadTagHistory,addTagHistory,visitStats,collectSlips,
