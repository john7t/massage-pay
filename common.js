...
// 用fetchAcupoints()動態載入,載入一次後快取在記憶體,同一個session不用重複抓取
...
window.MP={
  ...
  getCustomers,saveCustomers,getBookings,saveBookings,uid,upsertCustomer,normPhone,searchCustomers,addBooking,updateBooking,deleteBooking,confirmBooking,BOOK_TITLES,bookTitleName,fetchAcupoints,
