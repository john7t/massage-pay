/* ════════════════════════════════════════════════════════════
   ...
   v1.8-028 / 基資日期縮小+就讀類型上移預設大學+啟動頁深色+主管管理編輯工時+實習副理
...
/* ══════════ Supervisor levels ══════════ */
const SUP_LEVELS=[{id:5,zh:'實習副理',vi:'Phó QL thực tập'},{id:1,zh:'副理',vi:'Phó quản lý'},{id:2,zh:'經理',vi:'Quản lý'},{id:3,zh:'區經理',vi:'Quản lý khu vực'},{id:4,zh:'執行長',vi:'Giám đốc'}];
function supLevelName(id,lang){const lv=SUP_LEVELS.find(l=>l.id===id);return lv?(lv[lang]||lv.zh):''}
// 實習副理(5)權限等同副理(1);回傳用於權限比較的有效等級
function effSupLevel(id){return id===5?1:id}
