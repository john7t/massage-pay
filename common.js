/* ════════════════════════════════════════════════════════════
   ...
   v1.8-054 / 備份頁加完整JSON加密備份檔(匯出全部個人資料/匯入覆蓋,含結構標記+checksum驗證+人話錯誤訊息),保留舊月薪資備份碼
...
global.MP={
  ...
  toB36,fromB36,dim,dow,bizDate,bizParts,BIZ_CUTOFF_MIN,dk,eDay,stamp,calcSal,eMon,encMonth,decBackup,makePersonalBackup,parsePersonalBackup,restorePersonalBackup,
