...
// 團購(手套)
async function gasCreateGroupBuy(code,title,deadline){
  const r=await gasCallPost('createGroupBuy',{code,title,deadline},15000);
  return r||{ok:false,error:'GAS無回應'};
}
