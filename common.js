...
async function gasBackupSubmit(lineUserId,code,year,jsonData){
  const r=await gasCallPost('backupSubmit',{lineUserId,code,year,jsonData},20000);
  return r||{ok:false,error:'GAS無回應'};
}
