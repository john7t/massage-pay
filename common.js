/* ════════════════════════════════════════════════════════════
   ...
   v1.8-061 / D輕量:點管理先在index檢查權限(管理員admin.cfg/本機主管),有權限帶auto=1直接進管理頁(auth自動驗證跳過檢查頁),沒權限才到檢查頁
